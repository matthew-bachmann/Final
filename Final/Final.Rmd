...
##### **Exercise 3. Consider the histogram show below: (knit to view the image)   (1 points)**

<center>
<img src="./IMG1.png" width="350"/>
</center>

**(A.) Estimate the median for the $400$ observations shown in the histogram below. (hint: the bin width is 5)**
